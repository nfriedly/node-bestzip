...
- Only exit/return successfully when the destination.zip file was actually created or replaced.
...
- `--no-warn` on the command line and `warn: false` in the programmatic API to suppress just the advisory warnings while keeping the progress output. An explicit `warn: true` (or `--warn`) re-enables the warnings even under `quiet` / `--quiet`, so `--quiet --warn` logs warnings but not other output.
...
- Default to not following symlinks to prevent arbitrary file read ([GHSA-rq7v-fpj4-v4vc](https://github.com/nfriedly/node-bestzip/security/advisories/GHSA-rq7v-fpj4-v4vc))
...
## [3.0.3](https://github.com/nfriedly/node-bestzip/releases/tag/v3.0.3) - 2026-08-28

### Security

- Prevent native zip destination from being interpreted as a flag ([#99](https://github.com/nfriedly/node-bestzip/pull/99) / [GHSA-xhwx-rch4-ph2v](https://github.com/nfriedly/node-bestzip/security/advisories/GHSA-xhwx-rch4-ph2v))

## [3.0.2](https://github.com/nfriedly/node-bestzip/releases/tag/v3.0.2) - 2026-08-06

### Security

- Ensure input files can't be treated as command line flags ([#97](https://github.com/nfriedly/node-bestzip/pull/97) / [GHSA-p87m-9567-rgcc](https://github.com/nfriedly/node-bestzip/security/advisories/GHSA-p87m-9567-rgcc) / [CVE-2026-80427](https://www.cve.org/CVERecord?id=CVE-2026-80427) )

## [3.0.1](https://github.com/nfriedly/node-bestzip/releases/tag/v3.0.1) - 2026-05-21

### Changed

- Update archiver dependency ([#89](https://github.com/nfriedly/node-bestzip/pull/89))

## [3.0.0](https://github.com/nfriedly/node-bestzip/releases/tag/v3.0.0) - 2026-05-19

### Changed

- Migrate from CommonJS (CJS) to ESM ([#88](https://github.com/nfriedly/node-bestzip/pull/88))

## [2.2.5](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.5) - 2026-05-15

### Removed

- Remove unused `regenerator-runtime` dependency ([#85](https://github.com/nfriedly/node-bestzip/pull/85))

## [2.2.4](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.4) - 2026-05-15

### Changed

- Update minimum Node.js version to v20 ([#84](https://github.com/nfriedly/node-bestzip/pull/84))

## [2.2.3](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.3) - 2026-03-25

### Changed

- Upgrade glob and other dependencies

## [2.2.2](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.2) - 2026-03-20
...
## [2.2.1](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.1) - 2022-04-13
...
## [2.2.0](https://github.com/nfriedly/node-bestzip/releases/tag/v2.2.0) - 2021-03-18
...
## [2.1.7](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.7) - 2020-09-01

### Security

- Prevent shell command injection ([CVE-2020-7730](https://www.cve.org/CVERecord?id=CVE-2020-7730))

## [2.1.6](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.6) - 2020-07-27

### Fixed

- Follow linked folders when zipping ([#36](https://github.com/nfriedly/node-bestzip/pull/36))

## [2.1.5](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.5) - 2019-10-18
...
## [2.1.4](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.4) - 2019-05-15

### Changed

- Only publish source code, not tests

## [2.1.3](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.3) - 2019-05-15
...
## [2.1.2](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.2) - 2018-10-12

### Changed

- Update npm packages for compliance ([#24](https://github.com/nfriedly/node-bestzip/pull/24))

## [2.1.1](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.1) - 2018-09-11

### Fixed

- Work around archiver bug with adding directories on Windows

## [2.1.0](https://github.com/nfriedly/node-bestzip/releases/tag/v2.1.0) - 2018-09-10
...
## [2.0.0](https://github.com/nfriedly/node-bestzip/releases/tag/v2.0.0) - 2018-08-27
...
## [1.1.6](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.6) - 2018-08-23
...
## [1.1.5](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.5) - 2018-08-21
...
## [1.1.4](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.4) - 2017-03-20

### Fixed

- Zip files starting with a dot ([#4](https://github.com/nfriedly/node-bestzip/pull/4))

## [1.1.3](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.3) - 2016-01-29

### Changed

- Update package.json ([#3](https://github.com/nfriedly/node-bestzip/pull/3))

## [1.1.2](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.2) - 2015-07-03

### Fixed

- Correct order of destination & source params in readme ([#2](https://github.com/nfriedly/node-bestzip/pull/2))

## [1.1.1](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.1) - 2014-11-05

### Fixed

- Improved error handling

## [1.1.0](https://github.com/nfriedly/node-bestzip/releases/tag/v1.1.0) - 2014-10-28

### Added

- Support for multiple source files

## [1.0.1](https://github.com/nfriedly/node-bestzip/releases/tag/v1.0.1) - 2014-10-28
