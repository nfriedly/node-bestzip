...
// untrusted-search-path behavior can be tested in isolation. The caller sets
// the fixture's cwd and environment; the fixture just archives `app.js` from
// the cwd into the destination passed as argv[2] and reports what happened.
